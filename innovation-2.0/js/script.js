...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        if(document.getElementById('codeAiPopupModal')) {
            ...
            const innovatePopup = document.getElementById('innovatePopupModal');
            if (innovatePopup) {
                innovatePopup.classList.add('active');
            }
        }
    }, 2000);

    // Close Innovate 3.0 popup
    const innovatePopupClose = document.getElementById('innovatePopupClose');
    if (innovatePopupClose) {
        innovatePopupClose.addEventListener('click', function() {
            const innovatePopup = document.getElementById('innovatePopupModal');
            if (innovatePopup) innovatePopup.classList.remove('active');
        });
    }
    
    const innovatePopupLater = document.getElementById('innovatePopupLater');
    if (innovatePopupLater) {
        innovatePopupLater.addEventListener('click', function() {
            const innovatePopup = document.getElementById('innovatePopupModal');
            if (innovatePopup) innovatePopup.classList.remove('active');
        });
    }
    ...
    const innovatePopupRegister = document.getElementById('innovatePopupRegister');
    if (innovatePopupRegister) {
        innovatePopupRegister.addEventListener('click', function() {
            const innovatePopup = document.getElementById('innovatePopupModal');
            if (innovatePopup) innovatePopup.classList.remove('active');
            showPage('innovate');
        });
    ...
    const innovateEventBtn = document.getElementById('innovateEventBtn');
    if (innovateEventBtn) {
        innovateEventBtn.addEventListener('click', function() {
            showPage('innovate');
        });
    }
    
    // Back to Home from Innovate 3.0
    const backToHomeFromInnovate = document.getElementById('backToHomeFromInnovate');
    if (backToHomeFromInnovate) {
        backToHomeFromInnovate.addEventListener('click', function(e) {
            e.preventDefault();
            showPage('home');
        });
    }
